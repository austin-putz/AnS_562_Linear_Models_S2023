...
# topics in animal breeding such as optimal contribution selection, (economic)
# selection index, genomics, and many other topics.

# Matrices are 2 dimensional Arrays.
# They are unique from data frames in that all elements within the Matrix is
# of the same time.
# Data frames are lists with different types.
...
# load packages
# Use 'Pkg.add("PackageName")' if you don't have a package
using LinearAlgebra
using SparseArrays
using Random
using Distributions
...
# you can also return a matrix with this notation
A[[1],:]
